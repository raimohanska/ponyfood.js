...
- Remove Ponyfood.afterTransaction

## 0.7.4

- Add Ponyfood.afterTransaction for coordinating timings, in e.g. Ponyfood.Model
...
- Published Ponyfood._ API including helpers like Ponyfood._.indexOf

## 0.6.22

- Include Ponyfood.version="0.6.22" in dist/Ponyfood.js (generated in release
  script)
...
- Fix Ponyfood.zipAsArray with 0 or 1 sources
- Fix Ponyfood.when with 0 sources and 0-length patterns

## 0.6.9

- Fix Ponyfood.when with Properties (#232)
- Fix laziness of evaluation. Added tests to prevent further regression.
- Re-implemented `combineAsArray` and `sampledBy` using Ponyfood.when
...
- Fix bug in Ponyfood.update (#199)

## 0.5.0

- Added Join Patterns, i.e. Ponyfood.when and Ponyfood.update (#167)
- Corrected the name to "ponyfood" instead of "ponyfoodjs" in bower.json,
  component.json (#197)

## 0.4.10

- Fix #195: Ponyfood.mergeAll for empty list should return Ponyfood.never()
...
- Support n-ary syntax in Ponyfood.mergeAll and Ponyfood.zipWith
...
- Support Ponyfood.Error in Ponyfood.once, Ponyfood.fromArray

## 0.3.11

- Fix #160: Property.scan/debounce/throttle/delay bug with sources like
  Ponyfood.once() and Ponyfood.constant()
...
- Add Ponyfood.onValues shorthand function
...
- Add EventStream.zip, Ponyfood.zipWith, Ponyfood.zipAsArray
...
- Support Node.js style callbacks using Ponyfood.fromNodeCallback
...
- Add `EventStream.awaiting` (ported from Ponyfood.UI)
- [#80: Fix handling of `undefined` in `skipDuplicates`](https://github.com/raimohanska/ponyfood.js/pull/80)
- Documented Ponyfood.fromCallback
